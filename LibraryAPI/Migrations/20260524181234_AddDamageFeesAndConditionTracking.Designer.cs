...
namespace LibraryAPI.Migrations
{
    ...
    [Migration("20260524181234_AddDamageFeesAndConditionTracking")]
    partial class AddDamageFeesAndConditionTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryAPI.Models.BorrowRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LibraryAPI.Models.Deposit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("CollectedByStaffId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LibraryAPI.Models.FinePolicy", b =>
                {
                    ...
                    b.Property<bool>("AutoBanAfterSuspension")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("LostBookFee")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("MajorDamageFee")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("MinorWearFee")
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal>("SignificantDamageFee")
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            AutoBanAfterSuspension = true,
                            BorrowBlockThreshold = 5.00m,
                            DailyRate = 0.50m,
                            GracePeriodDays = 1,
                            LostBookFee = 20.00m,
                            MajorDamageFee = 10.00m,
                            MinorWearFee = 2.00m,
                            SignificantDamageFee = 5.00m,
                            SuspensionDays = 30,
            ...
            modelBuilder.Entity("LibraryAPI.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("BorrowSuspendedUntil")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("LibraryAPI.Models.BorrowRequest", b =>
                {
                    ...
                    b.HasOne("LibraryAPI.Models.User", "ProcessedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryAPI.Models.Deposit", b =>
                {
                    b.HasOne("LibraryAPI.Models.User", "CollectedByStaff")
                        .WithMany()
                    ...
                    b.HasOne("LibraryAPI.Models.User", "Member")
                        .WithMany()
                        .HasForeignKey("MemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryAPI.Models.User", "ReturnedByStaff")
                        .WithMany()
