        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    ReadingGoal = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookDonations_Users_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDonations_Users_ReviewedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonatedById = table.Column<int>(type: "INTEGER", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowBlockThreshold = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinePolicies_Users_UpdatedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DismissedRecommendations_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DismissedRecommendations_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Capacity = table.Column<int>(type: "INTEGER", nullable: false),
                    LinkedBookId = table.Column<int>(type: "INTEGER", nullable: true),
                    Status = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Books_LinkedBookId",
                        column: x => x.LinkedBookId,
                        principalTable: "Books",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Events_Users_CreatedByStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModeratedByStaffId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReviews_Loans_LoanId",
                        column: x => x.LoanId,
                        principalTable: "Loans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookReviews_Users_ModeratedByStaffId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WaivedByAdminId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Fines_Users_ConfirmedByStaffId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Fines_Users_WaivedByAdminId",
                        column: x => x.WaivedByAdminId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.InsertData(
                table: "FinePolicies",
                columns: new[] { "Id", "BorrowBlockThreshold", "DailyRate", "GracePeriodDays", "UpdatedAt", "UpdatedByAdminId" },
                values: new object[] { 1, 5.00m, 0.50m, 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null });

            migrationBuilder.CreateIndex(
                name: "IX_BookDonations_DonorId",
                table: "BookDonations",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_BookDonations_ReviewedByAdminId",
                table: "BookDonations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookReviews_LoanId",
                table: "BookReviews",
                column: "LoanId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookReviews_ModeratedByStaffId",
                table: "BookReviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DismissedRecommendations_BookId",
                table: "DismissedRecommendations",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_DismissedRecommendations_UserId_BookId",
                table: "DismissedRecommendations",
                columns: new[] { "UserId", "BookId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_CreatedByStaffId",
                table: "Events",
                column: "CreatedByStaffId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_LinkedBookId",
                table: "Events",
                column: "LinkedBookId");

            migrationBuilder.CreateIndex(
                name: "IX_FinePolicies_UpdatedByAdminId",
                table: "FinePolicies",
                column: "UpdatedByAdminId");

            migrationBuilder.CreateIndex(
                name: "IX_Fines_ConfirmedByStaffId",
                table: "Fines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Fines_WaivedByAdminId",
                table: "Fines",
                column: "WaivedByAdminId");
